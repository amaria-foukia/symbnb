...
class Booking
{
    ...
    /**
     * 
     * Callback à chaque fois qu'on fait une reservation
     * 
     * @ORM\PrePersist
     * @ORM\PreUpdate
     *
    ...
    public function isBookableDates(){
        ...
        //1) il faut connaitre les dates déjà prises donc impossibles
        $notAvailableDays   = $this->ad->getNotAvailableDays();

        //2) il faut comparer les dates choisies avec les dates impossibles(1)
        $bookingDays        = $this->getDays();

        //3) transformer les dateTime en chaines de caractères
    ...
    /**
     * Permet de récuperer un tableau contenant les jours de reservations
     *
     * @return array Un tableau d'objet dateTime representant les jours de reservations
     */
